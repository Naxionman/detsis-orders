...
@section('title', 'Επεξεργασία κίνησης - Detsis Orders')

@section('content')
<div class="container">
    <div class="card bg-c-blue bg-opacity-25 shadow-lg border-0 rounded-3 mt-3 ">
        <div class="card-header"><h3 class="text-center font-weight-light my-2 ">Επεξεργασία κίνησης οχήματος</h3></div>
            <div class="card-body bg-light">
                <form action="#" id="editDispatch" method="POST">
                    @method('PATCH')
                    <div class="row mt-3 justify-content-center">
                        <div class="col-sm-2"><label for="inputDispatchDate">Ημερομηνία</label></div>
                        <div class="col-sm-4"><input class="form-control" value="{{ $dispatch->dispatch_date->format('Y-m-d') }}" type="date" id="inputDispatchDate" name="dispatch_date"></div>
                    </div>
                    <div class="row mt-3 justify-content-center">
            ...
            <div class="card-footer text-center py-2">
                <button class="btn btn-danger" type="submit" form="editDispatch">  Αποθήκευση  </button>
                <a href="/dispatches" class="btn btn-primary">  Ακύρωση - Επιστροφή </a>
            </div>
        </div>
