<div class="row justify-content-center mt-1">
    <div class="col-6">
        <label for="dailyWages">Βασικός Μισθός</label>
    </div>
    <div class="col-3">
        <input class="form-control" type="number" step="0.01" name="basic_salary" id="basicSalary">
    </div>
</div>
<div class="row justify-content-center mt-1">
    <div class="col-6">
...
<div class="row justify-content-center mt-1">
    <div class="col-6">
        <label for="">Νόμιμος Μισθός</label>
    </div>
    <div class="col-3">
        <input class="form-control" type="number" step="0.01" name="total_salary" id="totalSalary">
    </div>
</div>
        <script>
            $('#basicSalary, #3yearBenefit, #marriageBenefit').on('change', function(){
                var basicSalary = $('#dailyWages').val();
                ...
                var total = Number(basicSalary) + Number(yearBenefit) + Number(marriageBenefit);
...
<div class="row justify-content-center mt-1">
    <div class="col-6">
        <label for="agreedSalarySum">ΣΥΝΟΛΟ ΣΥΜΦΩΝΗΘΕΝΤΟΣ ΜΙΣΘΟΥ</label>    
    </div>
    <div class="col-3">
        <input class="form-control" type="number" step="0.01" name="agreed_salary_sum" id="agreedSalarySum">
    </div>
</div>
