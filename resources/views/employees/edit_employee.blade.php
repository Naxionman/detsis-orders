    ...
    <div class="card bg-warning bg-opacity-25 shadow-lg border-0 rounded-3 mt-3 ">
        <div class="card-header"><h3 class="text-center font-weight-light my-2 ">Επεξεργασία στοιχείων εργαζόμενου</h3></div>
            <div class="card-body bg-light">
                <form action="/edit_employee/{{ $employee->id }}" id="addEmployee" method="POST">
                    @method("PATCH")
                    <div class="row">
                        <div class="col"><!-- Left Column -->
                            ...
                            <div class="row mt-1"> <!-- inner fifth row -->
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" value = "{{ employee->date_of_birth }}" autocomplete="nope" type="date"  id="inputDateOfBirth" name="date_of_birth" placeholder="Ημερομηνία γέννησης"  required="required">
                                </div>
                            </div>
                        ...
                        <hr style="margin-top: 0;">
                            ...
                            <div class="row mt-1"> <!-- inner second row -->
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" value = "{{ employee->contract_expiring }}" autocomplete="nope" type="date" id="inputContractExpiring" name="contract_expiring" placeholder="Ημερομηνία Λήξξης"">
                                </div>
                            </div>
                            ...
                            <div class="row mt-1"> <!-- inner third row -->
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" value = "{{ employee->date_joined }}" autocomplete="nope" type="date" id="inputDateJoined" name="date_joined" placeholder="Ημερομηνία Πρόσληψης"  required="required">
                                </div>
                            </div>
                            ...
                            <div class="row mt-1"> <!-- inner fourth row -->
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" value = "{{ employee->date_left }}" autocomplete="nope" type="date" id="inputDateLeft" value="" name="date_left" placeholder="Ημερομηνία Αποχώρησης"">
                                </div>
                            </div>
                            ...
                            <div class="row mt-1"> <!-- inner fifth row -->
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" value = "{{ employee->speciality }}" autocomplete="nope" type="text" id="inputSpeciality" name="speciality" >
                                </div>
                            </div>
