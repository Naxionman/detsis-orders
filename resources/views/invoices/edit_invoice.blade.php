                  ...
                  <div class="card bg-danger bg-opacity-75 border-0 rounded-3 shadow-sm">
                        ...
                        <div class="card-body bg-light">
                                 ...
                                 <select class="form-control js-example-basic-multiple" multiple='multiple'name="orders[]" id="boundOrders">
                                    @foreach ($details as $detail)
                                       @if ($detail->order_id == null)
                                          ...
                                          @break
                                       @else
                                          <option value="{{ $detail->order_id }}" selected>{{ $detail->order_id }}</option>
                                       @endif
                                    @endforeach
                           ...
                           <div class="row">
                              ...
                              <div class="col-6">
                                 <input class="form-control" type="date" value="{{ '-' }}" name="order_date">
                              </div>
                           </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-6">
                                    ...
                                    @else
                                       <input class="form-control" type="text" placeholder="Δεν έχει συσχετισθεί" disabled> 
                                    @endif
                               </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-6 text-end justify-content-center"><label class="align-middle">Αριθμός Τιμολογίου Προμηθευτή</label></div>
                              <div class="col-6">
                     ...
                     <div class="card-body bg-light">
                           <div class="row">
                              ...
                              <div class="col-5">
                                 <select class="form-control" name="shipper_id">
                                    ...
                                    @else
                                       <option value="">Καταχωρήστε φορτωτική (ΝΑ ΤΟ ΑΛΛΑΞΩ ΑΥΤΟ)</option>
                                    @endif
                           ...
                           <div class="row">
                              ...
                              <div class="col-5">
                                 ...
                                 @if ($invoice->shipment_id != null)
                                    <input class="form-control" type="text" name="shipment_invoice_number" value="{{ $invoice->shipment->shipment_invoice_number }}">
                                 @else
                                    <input class="form-control" type="text" name="shipment_invoice_number">
                                 @endif
                                 </label>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-5">
                                 <label class="align-middle">
                                 @if ($invoice->shipment_id != null)
                                    <input class="form-control" type="number" name="shipment_price" step="0.01" id="" value="{{ $invoice->shipment->shipment_price }}"> €
                                 @else
                                    <input class="form-control" type="number" name="shipment_price" step="0.01"  >
                                 @endif
                                 </label>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-5">
                                 <label class="align-middle">
                                 @if ($invoice->shipment_id != null)
                                    <select name="extra_shipper_id">
                                       <option value="{{ $shipment->extra_shipper_id }}" selected>{{ $shipment->extraShipper->name }}</option>
                                    </select>
                                 @else
                                 @endif
